<template>
  <div class="home">
    <div class="sidepanel">
      ...
      <div class="tags">
        <div class="tags-container">
          <div class="tag-element">All</div>
          <div class="tag-element">UI</div>
          <div class="tag-element">UX</div>
          <div class="tag-element">Enhancement</div>
          <div class="tag-element">Bug</div>
          <div class="tag-element">Feature</div>
        </div>
      </div>
      <div class="roadmap">
        <div class="roadmap-status">
          <div class="roadmap-name">Roadmap</div>
    ...
    <div class="suggestions">
      <div class="suggestions-navbar">
        <div class="sugestions-img">
          <svg
            class="suggestion-svg"
            width="23"
            height="24"
          ...
          <div class="suggestions-count">6 Sugesstions</div>
        </div>
      ...
      <div class="empty">
        ...
        <div class="empty-content">
          <div class="headline">There is no feedback yet.</div>
...
.beige-dot {
  height: 8px;
  width: 8px;
  background-color: rgba(244, 159, 133, 1);
  border-radius: 50%;
...
.purple-dot {
  height: 8px;
  width: 8px;
  background-color: rgba(199, 77, 203, 1);
  border-radius: 50%;
  display: inline-block;
  margin-right: 16px;
}
